...
public class Generics {
    public static void main(String[] args) {
        ...
        /* Ограничен сверху типом Predator, а first относится к типу Animal - выше по иерархии
        ...
        /* Ограничен снизу типом Predator, а third относится к типу Tiger - ниже по иерархии
        generics.printBoundedWildCard(first);
