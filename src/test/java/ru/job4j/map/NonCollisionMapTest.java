...
class NonCollisionMapTest {
    ...
    void whenMapExpand() {
        ...
        /* заменяю здесь и ниже "8"-ку на "5", т.к. судя по дальнейшим проверкам в тесте, этот элемент должен быть добавлен
          а если оставить "8", то это будет ситуация коллизии, которая по условию задачи не должна быть разрешаема
         */
        /*
         ...
         */
        assertThat(map).hasSize(7).contains(null, 1, 2, 3, 4, 5, 15);
    }
